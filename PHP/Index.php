<?php
  ...
  if(isset($_SESSION['user_Username']))
  {
    ...
    $HTML = str_replace('<createjob/>','
      ...
      <img src="..'. DIRECTORY_SEPARATOR .'IMG'. DIRECTORY_SEPARATOR .'Icons'. DIRECTORY_SEPARATOR .'write.png" class="icons" alt="icon create job offer page"> Create an Offer </a></li>',$HTML);
